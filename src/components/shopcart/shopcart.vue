    ...
    <div class="shopcart">
      <div class="content">
        ...
        <div class="content-right" @click.stop.prevent="pay">
          <div class="pay" :class="{'highlight':payDsc==='去结算'}">
            {{payDsc}}
          </div>
        </div>
      </div>
      ...
      <div class="ball-container">
        <transition name="drop" @before-enter="beforeEnter" @enter="enter" @after-enter="afterEnter"
                    v-for="(ball, index) in balls" :key="'aa'+index">
      ...
      <transition name="fold">
        <div class="shopcart-list" v-show="listShow">
          ...
          <div class="list-content" ref="listContent">
            <ul>
              <li class="food" v-for="(food, index) in selectFoods" :key="'bb'+index">
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    props: {
      selectFoods: {
        type: Array,
        // 当类型是Array或者Object时，设置默认值，需要用函数形式
        default () {
          return [
            {
              price: 20,
